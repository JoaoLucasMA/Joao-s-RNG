...
var text2 = "+ Direcão +\n\nJoão\n\n\n+ Programação +\n\nJoão\n\n\n+ Arte e animação +\n\nJoão\n\n\n+ Musicas +\n\nLAKEY INSPIRED - Chill Day\nFNF Vs Shaggy - \"Bag Music\"\nGenshin Impact - A Sweet Smile\nRhythm Heaven Fever - Greetings!\n\n\n+ Dubladores +\n\nVinicius - Bob\n\n\n+ Agradecimentos Especiais +\n\nLevi\nElmino\nDavid\nKrsna\nSamuel\nCaio\nZidane\nDaniel\nmãe e pai\n\ne você!\n\n\nFeito no\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nExotic Butters"
draw_text_leg(room_width/2, y, text2, 6, f_vcr22, fa_top, fa_middle, c_black, c_white)

draw_sprite_ext(spr_gamemaker, 0, room_width/2, y + 1310, 1, 1, 0, image_blend, image_alpha)